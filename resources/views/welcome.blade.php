            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                        <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-4">Visitors Over Time</h2>
                        <div class="h-56 flex items-center justify-center text-gray-400 dark:text-gray-500">
                            <!-- You can integrate a chart here using JS chart libraries -->
                ...
                <br>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                        ...
                        <ul class="text-gray-700 dark:text-gray-200 space-y-2">
                            <li>Most popular page: <span class="font-semibold">/home</span></li>
                            <li>Top country: <span class="font-semibold">Egypt</span></li>
                            <li>Average session duration: <span class="font-semibold">3m 45s</span></li>
